...
public class ClassUtil {
     ...
     * @return a A object.
     */
    public static <A extends Annotation> A getFieldAnnotation(Class<?> clazz, Class<A> annotationClass, String fieldName)
            throws Exception {
        try {
            ...
            LOG.error("access error: field[" + fieldName + "] in " + clazz.getCanonicalName(), e);
            throw new Exception("access error: field[" + fieldName + "] in " + clazz.getCanonicalName(), e);
        } catch (NoSuchFieldException e) {
            LOG.error("no such field[" + fieldName + "] in " + clazz.getCanonicalName(),e);
            throw new Exception("no such field[" + fieldName + "] in " + clazz.getCanonicalName());
        }
    }
    ...
    public static <A extends Annotation> A getMethodAnnotation(Class<?> clazz, Class<A> annotationClass,
        ...
        try {
            ...
            LOG.error("access error: method[" + methodName + "] in " + clazz.getCanonicalName(), e);
            throw new Exception("access error: method[" + methodName + "] in " + clazz.getCanonicalName(), e);
        } catch (NoSuchMethodException e) {
            LOG.error("no such method[" + methodName + "] in " + clazz.getCanonicalName(), e);
     ...
     */
     private static Set<Class<?>> getClasses(String pagekageName, boolean recursive) {
        // 第一个class类的集合
